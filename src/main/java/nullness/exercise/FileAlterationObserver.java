...
// This is a slightly modified version of a file from an Apache project,
// intended for use as a software engineering exercise for static analysis
// tools that find nullness bugs
package nullness.exercise;
...
public class FileAlterationObserver implements Serializable {
    ...
    @SuppressFBWarnings(value="SE_BAD_FIELD", justification="not nullness related")
